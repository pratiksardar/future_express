 ...
 *
 * Polish-pass timing: 200ms / frame → 1200ms full cycle. The original
 * 133ms (800ms cycle) flickered next to the masthead and pulled the eye
 * away from the wordmark. 1.2s reads as a deliberate mechanical loop
 ...
 *
 * Ported from src/app/design-preview/v4/PressOrnament.tsx.
 */
const FRAMES: string[] = [
  ` ┌────┐\n │░   │\n │    │\n └────┘`,
  ` ┌────┐\n │▒░  │\n │    │\n └────┘`,
